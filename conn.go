...
// Most users should only use it through github.com/ivansukach/super-sql package from the standard
// library.
...
func (cn *conn) Commit() (err error) {
	...
	// github.com/ivansukach/super-sql will release this connection back into the free connection
...
func (cn *conn) simpleQuery(q string) (res *rows, err error) {
	...
	for {
		...
		case 'C', 'I':
			...
			// well as Exec.  We still have to give github.com/ivansukach/super-sql a rows object
